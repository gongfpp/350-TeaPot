...
class ChatSocket:
    ...
    # 请求注册类型
    def register_user(self, user_name, password, file_name,file_reco_name):
        # 发送请求注册标记给服务器
        ...
        self.send_string_with_length(file_reco_name)
        # 调用实例方法获取返回值
    ...
    def send_string_with_length(self, content):
        ...
        print(bytes(content, encoding='utf-8').__len__().to_bytes(4, byteorder='big'))
        # 再发送内容
