...
class MainPanel:
    ...
    def show_main_panel(self):
        ...
        self.p1 = PhotoImage(file='pictures/微信表情1.png')
        self.p2 = PhotoImage(file='pictures/微信表情2.png')
        self.p3 = PhotoImage(file='pictures/微信表情3.png')
        self.p4 = PhotoImage(file='pictures/微信表情4.png')
        self.p5 = PhotoImage(file='pictures/微信表情5.png')
        ...
        self.p11 = PhotoImage(file='pictures/表情按钮.png')
        self.p12 = PhotoImage(file='pictures/聊天记录按钮.png')
        ...
        numIdx = 3  # gif的帧数
        # 循环遍历动图的帧
        frames = [PhotoImage(file='pictures/main.gif', format='gif -index %i' % (i)) for i in range(numIdx)]
        # 创建存储gif的标签
        imgLabel = Label(self.main_frame, height=500, width=500)
        # 设置标签的位置
    ...
    def update(idx):
        ...
        main_frame.after(1500, MainPanel.update, idx % numIdx)  # 100毫秒之后继续执行定时器函数
